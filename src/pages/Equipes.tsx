    ...
    <div className="space-y-6 animate-fade-in">
      <Breadcrumb className="mb-4 sm:mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbPage>Equipes</BreadcrumbPage></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold">Equipes</h1>
          <p className="text-sm text-muted-foreground">Organize seus colaboradores em equipes</p>
        </div>
        <div className="flex items-center gap-2 sm:gap-3 self-end sm:self-auto">
          ...
          <Button className="gap-2 shadow-lg shadow-primary/20 text-xs sm:text-sm" onClick={handleNew}>
            <Plus className="h-4 w-4" /><span>Nova Equipe</span>
          </Button>
        </div>
      </div>
