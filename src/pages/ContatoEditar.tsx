...
import { ArrowLeft, Save, Search, Upload, User, Plus, Calendar, Building, MapPin, Home, Settings, CreditCard, DollarSign, Calculator, FileText, Globe, Info, Search as SearchIcon, FileImage, Download, Eye, X, GripVertical, CheckCircle, Mail, Phone } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-3">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/contatos" className="flex items-center gap-1">
                Contatos
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Editar Contato</h1>
