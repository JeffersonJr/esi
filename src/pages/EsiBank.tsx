...
const SuccessState = ({ title, subtitle, amount, onClose }: { title: string, subtitle: string, amount?: string, onClose: () => void }) => (
  <div className="p-8 flex flex-col items-center justify-center text-center h-full min-h-[400px] space-y-6">
    ...
    <div className="space-y-2">
      ...
      {amount && (
        <div className="text-4xl font-semibold text-emerald-400 pt-4 drop-shadow-[0_0_15px_rgba(16,185,129,0.4)]">{amount}</div>
      )}
    </div>
    <div className="pt-8 w-full space-y-3">
      <Button variant="outline" className="w-full h-10 rounded-2xl font-bold text-emerald-400 border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20 transition-colors">Ver comprovante</Button>
      <Button variant="ghost" className="w-full h-10 rounded-2xl font-bold text-zinc-400 hover:text-white hover:bg-zinc-800" onClick={onClose}>Voltar ao início</Button>
    </div>
  </div>
);
      ...
      <div className="w-full max-w-[420px] bg-zinc-950 shadow-2xl min-h-[850px] relative rounded-[2.5rem] border-[8px] border-zinc-900 overflow-hidden font-sans flex flex-col ring-1 ring-zinc-800">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar pb-20 z-10 relative">
          ...
          <div className="px-6 pt-10 pb-6 space-y-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-zinc-500 font-medium tracking-tight">esi.bank</div>
            ...
            <div className="space-y-2 cursor-pointer group mt-4 p-5 rounded-2xl bg-gradient-to-br from-zinc-900/80 to-zinc-900/40 border border-zinc-800/50 backdrop-blur-xl shadow-xl relative overflow-hidden" onClick={() => setActiveView('history')}>
              <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 rounded-full blur-3xl" />
              <div className="flex items-center justify-between relative z-10">
                <h2 className="text-sm font-semibold text-zinc-400 tracking-tight">Saldo Disponível</h2>
                <ChevronRight className="h-5 w-5 text-zinc-600 group-hover:text-emerald-400 transition-colors" />
              </div>
              <div className="text-4xl font-semibold text-white tracking-tighter pt-1 relative z-10 drop-shadow-sm">
          ...
          <div className="px-6 space-y-4 cursor-pointer group" onClick={() => setActiveView('card')}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-bold text-zinc-300 tracking-tight">Cartão de crédito</h2>
              </div>
              <ChevronRight className="h-5 w-5 text-zinc-600 group-hover:text-zinc-400 transition-colors" />
            </div>
            <div className="space-y-1">
              <div className="text-xs font-semibold text-rose-400 tracking-tight">Fatura fechada</div>
          ...
          <div className="px-6 space-y-4 cursor-pointer group mb-8" onClick={() => setActiveView('loan')}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-bold text-zinc-300 tracking-tight">Empréstimo</h2>
              </div>
              <ChevronRight className="h-5 w-5 text-zinc-600 group-hover:text-zinc-400 transition-colors" />
            </div>
            <div className="space-y-2">
          ...
          <div className="px-6 space-y-6 cursor-pointer group" onClick={() => setActiveView('history')}>
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-bold text-zinc-300 tracking-tight">Histórico</h2>
              <ChevronRight className="h-5 w-5 text-zinc-600 group-hover:text-zinc-400 transition-colors" />
            </div>
            <div className="space-y-6 pt-2">
              {transacoesOriginais.slice(0, 3).map((t) => (
                <div key={t.id} className="flex gap-4 items-center">
                  <div className="w-12 h-9 rounded-xl bg-zinc-900/80 border border-zinc-800 flex items-center justify-center shrink-0 shadow-sm">
                    {t.icone}
                  </div>
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <div className={`text-sm font-semibold ${t.tipo === 'entrada' ? 'text-emerald-400' : 'text-zinc-300'}`}>
          ...
          {flowStep === 'menu' && (
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-zinc-400 tracking-tight">Minhas chaves</h3>
                <div className="bg-zinc-900/50 p-4 rounded-2xl border border-zinc-800/80 flex justify-between items-center group hover:border-zinc-700 transition-colors">
                  <div>
                    <div className="text-xs font-bold text-zinc-500 tracking-tight mb-1">CPF</div>
                ...
                <div className="bg-zinc-900/50 p-4 rounded-2xl border border-zinc-800/80 flex justify-between items-center group hover:border-zinc-700 transition-colors">
                  <div>
                    <div className="text-xs font-bold text-zinc-500 tracking-tight mb-1">E-mail</div>
            ...
            <div className="p-6 space-y-6">
              <div className="space-y-4">
                ...
                <Input
                  ...
                  className="h-10 bg-zinc-900/80 border-zinc-800 text-white rounded-xl focus:ring-emerald-500 focus:border-emerald-500"
                  value={inputValue}
              ...
              <Button
                className="w-full h-10 rounded-2xl font-bold bg-emerald-500 hover:bg-emerald-600 text-white text-lg shadow-[0_0_20px_rgba(16,185,129,0.3)]"
                disabled={!inputValue}
          ...
          {flowStep === 'confirm' && (
            <div className="p-6 space-y-6">
              <div className="space-y-8 pb-4">
                <h2 className="text-2xl font-semibold text-white">Confirme os dados do Pix</h2>
                <div className="bg-zinc-900/80 p-6 rounded-2xl border border-zinc-800 space-y-6 shadow-inner">
                  <div>
                    <div className="text-xs font-bold text-zinc-500 tracking-tight mb-1">Para</div>
                  ...
                  <div>
                    <div className="text-xs font-bold text-zinc-500 tracking-tight mb-1">Valor</div>
                    <div className="font-semibold text-3xl text-emerald-400">{formatCurrency(flowData.value)}</div>
                  </div>
                </div>
              </div>
              <Button className="w-full h-10 rounded-2xl font-bold bg-emerald-500 hover:bg-emerald-600 text-white text-lg shadow-[0_0_20px_rgba(16,185,129,0.3)]" onClick={() => setFlowStep('success')}>
              ...
              <div className="px-6 py-2 space-y-6 flex-1 overflow-y-auto no-scrollbar">
                ...
                <div className="w-full h-56 rounded-2xl p-6 relative overflow-hidden bg-gradient-to-br from-zinc-800 to-zinc-950 border border-zinc-700 shadow-2xl flex flex-col justify-between group cursor-pointer hover:border-zinc-600 transition-colors">
                  ...
                  <div className="relative z-10 flex justify-between items-start">
                    <div className="font-semibold text-xl text-white tracking-tight italic">esi.bank</div>
                ...
                <div className="space-y-2 mt-4">
                  <div className="text-rose-400 font-bold tracking-tight text-xs">Fatura fechada</div>
                  <div className="text-4xl font-semibold text-white tracking-tighter drop-shadow-sm">R$ 3.450,00</div>
                  <div className="text-sm font-semibold text-zinc-500">Vence dia 05 MAR</div>
                </div>
                <div className="flex gap-4">
                  <Button className="w-full h-9 rounded-xl font-bold bg-rose-500 hover:bg-rose-600 text-white shadow-[0_0_15px_rgba(244,63,94,0.3)] border-none" onClick={(e) => { e.stopPropagation(); setFlowData({ type: 'full', value: 3450 }); setFlowStep('confirm'); }}>Pagar fatura</Button>
                  <Button variant="outline" className="w-full h-9 rounded-xl font-bold border-zinc-700 bg-zinc-900 text-white hover:bg-zinc-800 hover:text-white" onClick={() => { setFlowData({ type: 'instalment' }); setFlowStep('input'); }}>Parcelar</Button>
                </div>
                ...
                <div className="space-y-6 pb-12">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-xs font-bold text-rose-400 tracking-tight cursor-pointer hover:text-rose-300">Ver todas</div>
                  </div>
                  <div className="space-y-6">
                    {transactionsCard.map((t) => (
                      <div key={t.id} className="flex justify-between items-center group">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-9 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center shrink-0 group-hover:border-zinc-700 transition-colors">
          ...
          {flowStep === 'input' && (
            <div className="p-6 space-y-6 pt-16">
              <div className="space-y-6 pb-4">
                <h2 className="text-2xl font-semibold text-white">Opções de parcelamento</h2>
                ...
                <div className="space-y-3 mt-4">
                  {[2, 3, 4, 5, 6].map(x => (
                    <div key={x} className="p-5 bg-zinc-900 border border-zinc-800 rounded-2xl hover:border-rose-500 cursor-pointer transition-all flex justify-between items-center group shadow-sm hover:shadow-[0_0_15px_rgba(244,63,94,0.15)]" onClick={() => { setFlowData({ type: 'instalment', value: 3450, splits: x }); setFlowStep('confirm'); }}>
                      <span className="font-semibold text-lg text-white">{x}x de {formatCurrency(3450 / x * 1.05)}</span>
                      <span className="text-xs font-bold text-zinc-500 tracking-tight group-hover:text-rose-400 transition-colors">com juros</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          {flowStep === 'confirm' && (
            <div className="p-6 space-y-6 pt-16">
              <div className="space-y-8 pb-4">
                ...
                <div className="bg-zinc-900 p-8 rounded-2xl border border-zinc-800 flex flex-col items-center justify-center space-y-3 shadow-inner">
                  <span className="text-xs font-bold text-zinc-500 tracking-tight">Valor a ser debitado na conta:</span>
                  <span className="text-4xl font-semibold text-rose-400 drop-shadow-[0_0_15px_rgba(244,63,94,0.3)]">
                    {flowData.type === 'full' ? formatCurrency(flowData.value) : formatCurrency((3450 / flowData.splits) * 1.05)}
                  </span>
                </div>
              </div>
              <Button className="w-full h-10 rounded-2xl font-bold bg-rose-500 hover:bg-rose-600 text-white text-lg shadow-[0_0_20px_rgba(244,63,94,0.3)] border-none" onClick={() => setFlowStep('success')}>Confirmar com Senha</Button>
            </div>
          )}
          {flowStep === 'success' && (
            <SuccessState
          ...
          <div className="p-6 space-y-6">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 h-10 bg-zinc-900 border-zinc-800 text-white focus:ring-emerald-500 focus:border-emerald-500 rounded-2xl text-lg font-medium"
                value={searchTerm}
