...
export function AutomacaoImobiliaria() {
  ...
  const stages = [{id: 's1', funnelId: '1', title: 'Novo', color: '#3b82f6'}, {id: 's2', funnelId: '1', title: 'Em Atendimento', color: '#eab308'}];
  const users = [{id: 'u1', name: 'Jefferson'}, {id: 'u2', name: 'Corretor'}];
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <TooltipProvider delayDuration={100}><Tooltip><TooltipTrigger asChild><button 
                      ...
                      >
                        <Edit2 size={24} />
                      </button></TooltipTrigger><TooltipContent><p>Editar Automação</p></TooltipContent></Tooltip></TooltipProvider>
                    ...
                    <TooltipProvider delayDuration={100}><Tooltip><TooltipTrigger asChild><button 
                      ...
                      >
                        <Copy size={24} />
                      </button></TooltipTrigger><TooltipContent><p>Duplicar Automação</p></TooltipContent></Tooltip></TooltipProvider>
                    ...
                    {!auto.savedAsTemplate && (
                      <TooltipProvider delayDuration={100}><Tooltip><TooltipTrigger asChild><button 
                        ...
                        >
                          <Library size={24} />
                        </button></TooltipTrigger><TooltipContent><p>Salvar como Template</p></TooltipContent></Tooltip></TooltipProvider>
                    )}
                    ...
                    <TooltipProvider delayDuration={100}><Tooltip><TooltipTrigger asChild><button 
                      ...
                      </button></TooltipTrigger><TooltipContent><p>{auto.isFavorite ? "Remover dos Favoritos" : "Favoritar"}</p></TooltipContent></Tooltip></TooltipProvider>
                    ...
                    <TooltipProvider delayDuration={100}><Tooltip><TooltipTrigger asChild><button 
                      ...
                      </button></TooltipTrigger><TooltipContent><p>{auto.status === 'active' ? "Pausar" : "Ativar"}</p></TooltipContent></Tooltip></TooltipProvider>
                    ...
                    <TooltipProvider delayDuration={100}><Tooltip><TooltipTrigger asChild><button 
                      ...
                      >
                        <Trash2 size={24} />
                      </button></TooltipTrigger><TooltipContent><p>Excluir</p></TooltipContent></Tooltip></TooltipProvider>
                  </div>
                </div>
              );
            })}
      ...
      <Dialog open={!!deleteTarget} onOpenChange={(open) => !open && setDeleteTarget(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{deleteTarget?.type === 'template' ? "Excluir Template?" : "Excluir Automação?"}</DialogTitle>
            <DialogDescription>
